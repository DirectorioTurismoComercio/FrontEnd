(function(){
	...
	.controller('redesSocialesController',['$http', '$scope', 'Constantes','UserFactory','RoleFactory',
		function redesSocialesController($scope,$http,$routeParams, UsuarioRedFactory,UsuarioRedesFactory, RedFactory) {
