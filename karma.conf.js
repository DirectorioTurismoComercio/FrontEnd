...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'public/components/angular-google-maps/dist/angular-google-maps-street-view.min.js',
            'public/components/angular-google-maps/dist/angular-google-maps-street-view_dev_mapped.min.js',
            'public/components/angular-simple-logger/dist/angular-simple-logger.light.min.js',
