...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'public/js/registerMunicipality/registerMunicipalityAccount/registerMunicipality.js',
            'public/js/registerMunicipality/registerMunicipalityAccount/registerMunicipality.controller.js',
